...
export const es: TranslationStructure = {
    ...
    modelGateway: {
        title: 'Pasarela de modelos',
        footer: 'Se guarda en este ordenador y se entrega al agente cuando arranca. La key no vuelve a mostrarse, ni aquí ni en ningún sitio.',
        footerReadOnly: 'Configúralo en el propio ordenador. Su daemon las guarda y un navegador no puede llegar a ellas.',
        apiKey: 'API key',
        apiKeyHint: 'Se entrega al agente cuando arranca, y no vuelve a mostrarse',
        apiKeyPlaceholder: 'La key de tu cuenta de la plataforma',
        baseUrl: 'Dirección de la pasarela',
        baseUrlHint: 'Donde responde la plataforma, por ejemplo https://gateway.example/v1',
        baseUrlPlaceholder: 'https://gateway.example/v1',
        modelId: 'Modelo',
        modelIdHint: 'El modelo con el que funcionan tus agentes',
        modelIdPlaceholder: 'vendor/model',
        set: 'Configurado',
        notSet: 'Sin configurar',
        unknown: 'Desconocido',
        save: 'Guardar',
        empty: 'Escribe un valor.',
        notOneLine: 'Ese valor contiene un salto de línea o un carácter de control.',
        saveFailed: 'Este ordenador no aceptó ese valor; no se cambió nada.',
    },
    archivedAgents: {
    ...
    relay: {
        ...
        unreachableTitle: "No se puede acceder al relé",
        unreachableBody: "La dirección que se dio a la aplicación no responde. Comprueba la dirección o cierra la sesión de esta cuenta.",
        rejectedTitle: "El relé rechazó esta cuenta",
        rejectedBody: "Algo respondió en esa dirección, pero no para esta cuenta. Comprueba la dirección o cierra la sesión y vuelve a entrar.",
    },
