...
export const pl: TranslationStructure = {
    ...
    modelGateway: {
        title: 'Brama modeli',
        footer: 'Zostaje na tym komputerze i trafia do agenta przy starcie. Key nie jest pokazywany ponownie — ani tutaj, ani nigdzie indziej.',
        footerReadOnly: 'Ustaw je na samym komputerze. Trzyma je jego demon, a przeglądarka do nich nie sięgnie.',
        apiKey: 'API key',
        apiKeyHint: 'Trafia do agenta przy starcie i nie jest pokazywany ponownie',
        apiKeyPlaceholder: 'Key z twojego konta platformy',
        baseUrl: 'Adres bramy',
        baseUrlHint: 'Gdzie odpowiada platforma, na przykład https://gateway.example/v1',
        baseUrlPlaceholder: 'https://gateway.example/v1',
        modelId: 'Model',
        modelIdHint: 'Model, na którym działają twoi agenci',
        ...
        save: 'Zapisz',
        empty: 'Wpisz wartość.',
        notOneLine: 'Ta wartość zawiera złamanie wiersza lub znak sterujący.',
        saveFailed: 'Ten komputer nie przyjął tej wartości; nic nie zmieniono.',
    },
    archivedAgents: {
    ...
    files: {
        ...
        listUnavailable: 'Nie udało się wyświetlić listy plików',
