...
export const it: TranslationStructure = {
    accountPage: {
        ...
        platformKey: 'API key della piattaforma',
        platformKeyHint: 'Si inserisce su ogni computer e resta nel suo archivio credenziali. Questa app non la possiede mai.',
