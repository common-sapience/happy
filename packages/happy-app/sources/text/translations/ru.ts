...
export const ru: TranslationStructure = {
    accountPage: {
        ...
        platformKey: 'API key платформы',
        platformKeyHint: 'Вводится на каждом компьютере и хранится в его хранилище учётных данных. Это приложение им никогда не владеет.',
