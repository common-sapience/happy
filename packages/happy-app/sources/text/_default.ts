...
export const en = {
    ...
    modelGateway: {
        title: 'Model gateway',
        footer: 'Kept on this computer and handed to an agent when it starts. The key is never shown again, here or anywhere else.',
        footerReadOnly: 'Set these on the computer itself. Its daemon holds them, and a browser cannot reach them.',
        apiKey: 'API key',
        apiKeyHint: 'Handed to the agent when it starts, and never shown again',
        apiKeyPlaceholder: 'The key from your platform account',
        baseUrl: 'Gateway address',
        baseUrlHint: 'Where the platform answers, such as https://gateway.example/v1',
        baseUrlPlaceholder: 'https://gateway.example/v1',
        modelId: 'Model',
        modelIdHint: 'The model your agents run on',
        ...
        save: 'Save',
        empty: 'Enter a value.',
        notOneLine: 'That value has a line break or a control character in it.',
        saveFailed: 'This computer did not take that value; nothing was changed.',
    },
    archivedAgents: {
